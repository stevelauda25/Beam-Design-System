...
import { Button as PodButton } from "@beam/ui/button";
import { Checkbox as PodCheckbox } from "@beam/ui/checkbox";
import { TextInput as PodTextInput } from "@beam/ui/text-input";
import { SearchInput as PodSearchInput } from "@beam/ui/search-input";
import { Switch as PodSwitch } from "@beam/ui/switch";
import { Dropdown as PodDropdown } from "@beam/ui/dropdown";
import { Badge as PodBadge } from "@beam/ui/badges";
import { Tab as PodTab } from "@beam/ui/tabs";
import { Radio as PodRadio } from "@beam/ui/radio";
import { Tag as PodTag } from "@beam/ui/tag";
import { ButtonGroup as PodButtonGroup } from "@beam/ui/button-group";
    ...
    <div className="w-[272px] bg-cn-surface border-r border-cn-border-default flex flex-col shrink-0 min-h-0 h-full">
      ...
      <div className="px-3 h-8 border-t border-cn-border-subtle shrink-0 flex items-center cn-mono-meta">
        {showLayers
          ...
          : <>from <span className="text-cn-text-secondary">@beam/ui</span> · click to add</>}
      </div>
    </div>
  );
}
