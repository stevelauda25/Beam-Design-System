...
- `pnpm --filter @beam/tokens build` after changing `theme.css` / `tailwind-preset.ts`
- `pnpm --filter @beam/ui build` after changing any component
...
Run: `pnpm --filter @beam/tokens build`
...
## Task 14: Build `@beam/ui` to verify all component changes typecheck
